...
@ApiOperation(value = "Returns the CartItems instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public CartItems getCartItems(@RequestParam("cartId") Integer cartId,@RequestParam("productId") Integer productId) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public CartItems editCartItems(@RequestParam("cartId") Integer cartId,@RequestParam("productId") Integer productId, @RequestBody CartItems cartItems) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteCartItems(@RequestParam("cartId") Integer cartId,@RequestParam("productId") Integer productId) throws EntityNotFoundException {
